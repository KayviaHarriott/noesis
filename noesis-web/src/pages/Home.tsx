export const Home = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      <div className="bg-gray-100 flex flex-col items-center justify-center min-h-screen text-center px-4">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold mb-4 text-blue-600">Noesis BPO Web App</h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center w-full">
            ...
            <a
              href="http://noesisbpo.netlify.app/agent"
              target="_blank"
