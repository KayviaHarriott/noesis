    ...
    <div className="p-3">
      ...
      <div className="glass-panel p-3 mb-3">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              🚧 Click to Open Development Platform
              <span className="absolute inset-0 rounded-xl bg-gradient-to-r from-blue-400 to-purple-400 blur opacity-40 animate-pulse -z-10"></span>
            </button>
            <button
              onClick={toggleTheme}
              className="px-3 py-2 bg-slate-800/40 hover:bg-slate-700/40 border border-slate-700/30 rounded-lg transition flex items-center gap-2"
            >
              {/* <i className={`fas ${isLight ? <p>Dark Mode</p> : <p>Light Mode</p>} text-sm text-gray-400`}/> */}
              {isLight ? <p>Dark Mode</p> : <p>Light Mode</p>}
            </button>
      ...
      >
        ...
        <div className="col-span-12 md:col-span-2 space-y-3 overflow-y-auto scrollbar-thin pr-1 mobile-sidebar">
          ...
          <div className="glass-panel p-3">
            ...
            <div className="flex items-center gap-3 mb-4">
              <img
                src="https://ui-avatars.com/api/?name=Sarah+J&background=3b82f6&color=fff&size=40"
          ...
          <div className="glass-panel p-3">
            ...
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-yellow-500 to-orange-500 flex items-center justify-center ring-2 ring-yellow-500/30 text-white font-semibold text-sm">
                MC
              </div>
              <div className="flex-1">
          ...
          {/* Customer Voice */}
          {/* <div className="glass-panel p-3">
            <Link to="/client" onClick={handleOpenClient}>
            ...
            <div
              className="bg-slate-800/30 rounded mb-3 p-3 flex items-end justify-between gap-1"
              style={{ height: 60 }}
            >
        ...
        <div className="col-span-12 md:col-span-4 flex flex-col gap-3 overflow-y-auto scrollbar-thin pr-1">
          ...
          <div className="glass-panel p-3">
            <div className="flex items-center gap-2 mb-3">
              <i className="fas fa-book text-blue-400 text-sm" />
              <h3 className="font-semibold text-sm">Relevant Documents</h3>
            </div>
            <div className="border rounded p-3 bg-gray-50/5 mb-3 min-h-[120px]">
              <p className="text-xs text-gray-400 mb-1">
                # of Docs: {relevantDocs.length}
              </p>
              {relevantDocs.length > 0 ? (
                <div className="space-y-2">
                  {relevantDocs.map((doc, i) => (
                    <div
                      key={i}
                      className="border-b border-slate-700 pb-1 mb-1"
                    >
